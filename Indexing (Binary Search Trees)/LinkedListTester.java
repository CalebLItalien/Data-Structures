...
public class LinkedListTester {
    ...
    public void testContains() {
        LinkedList emptyLinkedList = new LinkedList();
        assertFalse(emptyLinkedList.contains("data"));
        assertFalse(emptyLinkedList.contains(""));

        LinkedList linkedList = makeLinkedList();
        assertTrue(linkedList.contains(""));
        assertTrue(linkedList.contains("A"));
        assertTrue(linkedList.contains("FFF"));

        assertFalse(linkedList.contains(" "));
        assertFalse(linkedList.contains("a"));
        assertFalse(linkedList.contains("FFFF"));
    }
