 ...
 * nodes in the list or zero if there are no nodes. The last node in the list points to null.
 */
...
public class LinkedList<T extends Comparable<T>> {
    ...
    /**
     * Checks if the given data is in the linked list
     *
     * @param data value to find
     * @return true if the value is in the list, else false
     */
    public boolean contains(T data) {
        return contains(firstNode, data);
    }

    /**
     * Helper method for checking if the given data is in the linked list
     *
     * @param nextNode the node to compare the data of
     * @param data value to find
     * @return true if the data is found, false if the whole list has been traversed and the data not found, else a
     * pointer to the next node to be compared
     */
    private boolean contains (ListNode<T> nextNode, T data){
        if (nextNode == null){
            return false;
        }
        else if (nextNode.data.equals(data)){
            return true;
        }
        else{
            return contains(nextNode.next, data);
        }
    }
